...
class Piloto(ClaseModelo):
    ...
    nombre_auxiliar= models.CharField(max_length=50)
...
class Ingreso_guias(ClaseModelo):
    ...
    class Meta:
        ...
        db_table="link_ingreso_guias"

class Producto(ClaseModelo):
      #Descripcion de Envio 
    guia = models.ForeignKey(Ingreso_guias, related_name="productodet", on_delete=models.CASCADE)
    ...
    class Meta:
        ...
        db_table = "productodet"

class Ingreso_hijas(ClaseModelo):
    guia_madre=models.CharField(max_length=6, verbose_name="Guia Madre")
    guia_hija=models.CharField(max_length=10, verbose_name="Guia Hija")

    def __str__(self):
        return '{}'.format(self.guia_madre)

    def save(self):
        #self.guia_madre = self.guiamadre.upper()
        super(Ingreso_hijas, self).save()
    class Meta:
        verbose_name_plural = "Ingresos Hijas"
        verbose_name = "Ingreso Hija"

class Correlativo(ClaseModelo):
    ...
    def __str__(self):
        return '{}'.format(self.no_inicial)

    def save(self):
        self.no_inicial =self.no_inicial.upper()
        super(Correlativo, self).save()
