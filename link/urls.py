...
urlpatterns = [
    ...
    path('ingreso/new', ingresonew, name="ingreso_new"),
    path('buscar_cli', buscarcli.as_view(), name="buscar_cli"),
    path('buscar_des', buscardes.as_view(), name="buscar_des"),
    path('buscar_prd', buscarprod.as_view(), name="buscar_prod"),
    
    path('ingreso_hijas/new', hijanew.as_view(), name="ingreso_hijas"),

    path('correlativo/list', correlativoview.as_view(), name="correlativo_list"),
    path('correlativo/new', correlativonew.as_view(), name="correlativo_new"),
    path('correlativo/edit<int:pk>', correlativoedit.as_view(), name="correlativo_edit"),
